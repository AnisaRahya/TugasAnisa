...
<html lang="en">
  ...
  <body>
    ...
    <form action='{{url('pengguna/save')}}' method='post'>
    @csrf
  ...
  <div class="form-group">
    ...
    <input type="text" name='username'  value='{{@$data->Username}}'class="form-control" id="exampleInputPassword1" placeholder="Username">
  </div>
  <div class="form-group">
